...
try {
  ...
  await evaluate("Array.from(document.querySelectorAll('.member-list li')).find(li => li.textContent.includes('검증 B')).querySelector('button').click()")
  ...
  await waitFor(hasText('생성자가 정산 종료를 표시했어요.'))
