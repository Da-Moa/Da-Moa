...
| `/home/rounds/[roundId]` | 사용자 현지 생성일별 구분선이 있는 기록 목록·작성·증빙, 카카오 프로필 이미지가 포함된 참여자 노드와 지출 변경에 따라 갱신되는 본인 기준 예상·최종 송금 관계도, 전체 지출·관계별 금액의 자릿수별 증감 애니메이션, 권한별 수정·삭제·제외, 확정·재오픈·취소·전송 |
